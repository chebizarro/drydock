...
type ReviewRequest struct {
	...
	ExpectedVersion *int64   `json:"expected_version,omitempty"` // Future optimistic session version
	Message         string   `json:"message,omitempty"`          // Future conversational follow-up text
}
